				...
				<div class="oh-content-detail">
					...
					<div class="overflow-hidden mg-20">
						...
						<div class="oh-title zl-bg-pink pd-10 zl-tx-black bd">
							<div class="col-sm-6"><h4 class="tx-medium tx-18">Order ID : ZL00012019</h4></div>
							<div class="col-sm-6 tx-right"><h4 class="tx-medium tx-14"> Shipping Origin : <strong>Jakarta</strong></h4></div>
						</div>
							...
							<div class="row mg-0 pd-b-20 bd-b oh-content">
								<div class="row mg-0 mg-b-10">
									<div class="mg-10 mg-t-30">
										<div class="col-sm-2 pd-0"><img src="http://zolaku.nevsky.tech/images/600x600/89866629d3d149538926f666b6ed7738.jpg"></div>
										<div class="col-sm-10 mg-0 pd-0 tx-medium zl-tx-black product-detail">
											<div class="row mg-0">
												<div class="col-sm-9 pd-r-0">
													<h4 class="zl-tx-black tx-bold tx-16 mg-t-0">Jaket Hoodie Pria</h4>
												</div>
												<div class="col-sm-3"><span class="badge mg-t-0 ft-right u-bg--badge__blue">50 Point</span></div>
											</div>
											...
											<div class="row mg-0">
												...
												<div class="col-sm-6 pd-r-0">
													<div class="col-sm-4">500 Gr</div>
													<div class="col-sm-6">
														<span class="tx-bold d-lg-block">Rp. 200.000</span>
													</div>
													<div class="col-sm-1">10</div>
												</div>
												<div class="col-sm-3 pd-r-0 tx-16 tx-bold tx-right">Rp. 20.000.000</div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row mg-0 ft-left wd-100p bd-b">
								<div class="col-sm-12 mg-0 tx-medium zl-tx-black tx-13 pd-10 lh-3 tx-center">
									<div class="col-sm-4 tx-left">
										...
										<span class="col-sm-12 pd-0 tx-bold">2000 Gr</span>
									</div>
									<div class="col-sm-4">
									...
									<div class="col-sm-4 tx-right">
										...
										<span class="col-sm-12 pd-0 tx-bold">Rp. 22.000</span>
									</div>
								</div>
							</div>
							...
							<div class="row mg-0 ft-left wd-100p bd-b">
								<div class="col-sm-12 mg-0 tx-semibold zl-tx-black tx-13 pd-10 zl-bg-pink tx-center">
									<div class="col-sm-4 tx-left bd-r">
										...
										<span class="col-sm-12 pd-0 tx-16 zl-tx-red--light">JNE Regular</span>
									</div>
									<div class="col-sm-4 bd-r">
										<span class="col-sm-12 pd-0">No. Resi</span>
										<span class="col-sm-12 pd-0 tx-16 zl-tx-red--light">JNE12345678</span>
									</div>
									<div class="col-sm-4 tx-right">
				...
				<div class="oh-payment-detail zl-tx-black lh-3">
					<div class="row mg-0 pd-20">
						<div class="col-sm-12 pd-0 bd-b pd-t-10 pd-b-10">
							...
							<div class="w-100p tx-semibold tx-16">INV-ZL001</div>
						</div>
						<div class="col-sm-12 pd-0 bd-b pd-t-10 pd-b-10">
							<div class="w-100p tx-medium tx-12">Tanggal Pesanan</div>
							<div class="w-100p tx-semibold tx-16">Jumat, 05-05-2019</div>
						</div>
						<div class="col-sm-12 pd-0 bd-b pd-t-10 pd-b-10">
							<div class="w-100p tx-medium tx-12">Status Invoice</div>
							<div class="w-100p tx-semibold tx-16">Diproses</div>
						</div>
						<div class="col-sm-12 pd-0 bd-b pd-t-10 pd-b-10">
							<div class="w-100p tx-medium tx-12">Voucher</div>
							<div class="w-100p tx-semibold tx-16">LUCKYMARCH</div>
							<div class="w-100p tx-medium tx-12 zl-tx-red--light">Potongan harga Rp. 10.000</div>
						</div>
						...
						<div class="col-sm-12 pd-0 bd-b pd-t-10 pd-b-10">
							...
							<div class="w-100p tx-semibold tx-16">Bank Transfer - BCA</div>
						...
						<div class="col-sm-12 pd-0 bd-b pd-t-10 pd-b-10">
							...
							<div class="w-100p tx-semibold tx-16 pd-t-5 pd-b-5">Username</div>
							<div class="w-100p tx-medium tx-12 lh-5">
								Sanggar Kencana XXIII No. 01, Jatisari, Bandung<br>
								082212345678
							</div>
						</div>
					</div>
