                ...
                <div class="c-checkout-card">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="text-align: center;">
                            Silahkan setting username / nama pengguna agar dapat melakukan fitur chat.
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group form-group-lg">
                                <label class="control-label" for="input-phone-label"></label>
                                    <?= $this->Form->control('username', ['label' => false, 'div' => false, 'class' => 'form-control', 'placeholder' => 'username anda', 'errorx' => false]); ?>
                            </div>
                        </div>
                        <div class="col-lg-12">
