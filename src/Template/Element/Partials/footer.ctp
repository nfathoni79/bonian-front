        ...
        <div class="zl-chat-container clearfix">
            ...
            <div class="chat">
                ...
                <div class="chat-message clearfix"> 
                    ...
                    <a class="chat-upload-image" style="margin-right: 10px;" title="Unggah gambar"><i class="far fa-images" style="font-size: 18px; color: #999999"></i></a>
                    <a class="chat-emoji-picker"><i class="far fa-grin-alt" style="font-size: 18px; color: #999999"></i></a>
                    <button>Send</button>
