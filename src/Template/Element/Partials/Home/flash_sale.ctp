                            ...
                            <div class="right-block right-b">
                                ...
                                <div class="caption">
                                    ...
                                    <div class="button-group so-quickview cartinfo--static share-container">
                                        ...
                                        <button type="button" class="btn-share b-wc smsShare" data-url="<?php echo $this->Url->build(['controller' => 'Products', 'action' => 'detail', $flash_sale['product']['slug'],'prefix' => false],true);?>" data-title="<?= $flash_sale['product']['name'];?>" data-price="<?= $flash_sale['product']['price_sale'];?>"><i class="fab fa-comment-dots"></i></button>
