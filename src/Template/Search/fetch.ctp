        ...
        <div class="product-layout products col-lg-3 col-md-4 col-sm-4 col-xxs-6 col-xs-12">
            <div class="product-item-container">
                ...
                <div class="right-block right-b">
                    <?php /*<div class="row">
                        <div class="col-lg-7"  style="width: 48% !important; display: inline-block;">
                        ...
                        <div class="col-lg-5" style="width: 48% !important; display: inline-block;"><span style="margin-top: 0; padding: 5px 10px;" class="badge <?= $this->Badge->format($product['point']); ?> "><?= $product['point']; ?> Poin</span></div>
                    </div>*/ ?>
                    <?php /*
